...
public class Day7 {
    ...
    public static List<Integer> solve(String input) {
        ...
        sol.b.addAll(sol.a);
        return sol.b.stream().sorted().collect(Collectors.toList());
    }
    public static Object solveStar1(String input) {
        return solve(input).stream().reduce(0, (acc, i) -> i <= 100000 ? acc + i : acc);
    }
    public static Object solveStar2(String input) {
        List<Integer> a = solve(input);
